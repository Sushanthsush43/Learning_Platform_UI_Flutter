...
import 'package:learning/pages/course_page.dart';
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CoursePage(img: imgList[index]),
                        ),
                      );
                    },
                    child: Container(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(
              icon: Icon(Icons.assignment), label: 'Wishlist'),
          BottomNavigationBarItem(
